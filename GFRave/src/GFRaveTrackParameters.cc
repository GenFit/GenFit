...
GFRaveTrackParameters::GFRaveTrackParameters(const Track* track,  double weight, const TVectorD & state6, const TMatrixDSym & cov6x6, bool isSmoothed) :
...
GFRaveTrackParameters::GFRaveTrackParameters(const Track* track, double weight) :
  originalTrack_(const_cast<Track*>(track)),
  weight_(weight),
  state_(1,6),
  cov_(6,6),
