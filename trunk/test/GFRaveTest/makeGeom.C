void makeGeom()
{
  ...
  //   gSystem->Load("libGeom");
   ...
   TGeoVolume *redBullCan = gGeoManager->MakeTube("redBullCan", sil, 3.-0.01, 3., 18.);//, 90., 270.);
   redBullCan->SetLineColor(kRed);
   top->AddNode(redBullCan, 1, gGeoIdentity);

   TGeoVolume *redBullCan2 = gGeoManager->MakeTube("redBullCan2", sil, 4.-0.01, 4., 20.);//, 90., 270.);
